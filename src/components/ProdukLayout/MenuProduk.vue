                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-text-field label="Stok Minimal*" v-model="form.min_stok" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-text-field label="Jumlah Stok*" v-model="form.jumlah_stok" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-select label="Satuan*" v-model="form.satuan" :items="items" required>
                                </v-select>
                            </v-col>
                            <v-col cols="12">
